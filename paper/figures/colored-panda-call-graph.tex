\begin{figure}
    ...
    \end{tikzpicture}
    \caption[Color-coded Call Graph for Listing \ref{lst:pandasource}.  Functions tagged\break \lstinline{static_memory} are highlighted green and functions tagged\break \lstinline{dynamic_memory} are highlighted red.]{Color-coded Call Graph for Listing \ref{lst:pandasource}.  Functions tagged \lstinline{static_memory} are highlighted green and functions tagged \lstinline{dynamic_memory} are highlighted red.}
